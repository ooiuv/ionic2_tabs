...
export const APP_SERVE_URL = 'http://88.128.19.209:10000/api/'; // 闫小军
...
export const FILE_SERVE_URL = 'http://172.16.19.136:8089/kit_file_server/'; // 文件服务:测试环境
// export const FILE_SERVE_URL = 'http://192.168.1.127:8080/'; // 文件服务:测试环境

/*----------------------------------------app版本升级服务地址,查询app最新版本号,更新日志.----------------------------------------*/
// export const APP_VERSION_SERVE_URL = 'http://172.16.19.136:9001/api/'; // 闫小军
