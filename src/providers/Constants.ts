...
export const APP_NAME = 'liveWord';//app英文名称;需要和config.xml中的id保存一致;如id为com.kit.test.则此名称应为test
export const APP_VERSION = '2.0.0';//app版本号;需要和config.xml中的version保存一致
