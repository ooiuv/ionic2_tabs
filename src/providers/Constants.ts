...
export const DEFAULT_AVATAR = './assets/img/qr_code.png';//用户默认头像
export const PAGE_SIZE = 5;//默认分页大小
export const ANDROID_APK = 'http://172.16.19.86/kit_file_server/file/android-test.apk';//android apk下载完整地址
